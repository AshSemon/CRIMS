...
if(isset($_POST['submit'])){
	...
	if(mysqli_num_rows(mysqli_query($con,$sql))>0){
		...
		if($id==''){
			mysqli_query($con,"insert into cases_invest(cases_id,invest_statement,status,added_on) values('$did','$invest_statement',1,'$added_on')");
            ...
            <div class="card-body">
                <form class="forms-sample" method="post" enctype="multipart/form-data" id="content-form">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="invest_statement" placeholder="Court Decision statement" id="content" class="summernote" required><?php echo isset($_SESSION['POST']['content']) ? $_SESSION['POST']['content'] : (isset($_GET['page']) ? file_get_contents("./pages/{$_GET['page']}") : '')  ?><?php echo $invest_statement?></textarea>
                    </div>
                </form>
            </div>
