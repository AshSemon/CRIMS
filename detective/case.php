...
$sql="select cases.*,category from cases,category where cases.detective_id='".$_SESSION['DETECTIVE_ID']."' and casetype='0' and cases.category_id=category.id  order by cases.id desc limit 6";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <span>
                            <?php
                            echo "<h5>Archive :- ".getArchiveById($row['archive_id'])."</h5>"
                            ?>
                        </span>
                        <div class = "item-price">
                        <?php if($row['sended']=='0'){ ?>
                            <?php if($row['investigation']==''){ ?>
                                <a href="manage_cases.php?id=<?php echo $row['id']?>"><label class="btn btn-success mr-2 hand_cursor">Add Investigation</label></a>
                            <?php }else{ ?>
                                <a href="manage_cases.php?id=<?php echo $row['id']?>"><label class="btn btn-secondary mr-2 hand_cursor">Edit Investigation</label></a>&nbsp;
                            <?php } ?>
                        <?php }else{ ?>
