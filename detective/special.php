...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and casetype='1' and cases.detective_id='".$_SESSION['DETECTIVE_ID']."' order by cases.id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php
                        echo "<h6>Archive :- ".getArchiveById($row['archive_id'])."</h6>"
                        ?>
