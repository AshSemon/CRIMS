...
<div class="main-panel">
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $sql="select * from cases where cases.detective_id='".$_SESSION['DETECTIVE_ID']."' and added_on between '".date('Y-m-d')." 00-00-00' and '".date('Y-m-d')." 23-59-59' ";
            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="font-weight-light mb-4">
                        ...
                        $end=date('Y-m-d'). '23-59-59';
                        $sql="select * from cases where cases.detective_id='".$_SESSION['DETECTIVE_ID']."' and added_on between '$start' and '".date('Y-m-d')." 23-59-59' ";
                        $res=mysqli_query($con,$sql);
                        if($row=mysqli_num_rows($res)){
                            echo"<h4 class='mb-0'>".$row."</h4>";
                        }else{
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Weekly Cases</h4>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Monthly Cases</h4>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        <div>
                            <h4 class="font-weight-normal">Yearly Cases</h4>
    ...
    <?php
    $sql="select cases.*,category from cases,category where cases.detective_id='".$_SESSION['DETECTIVE_ID']."' and cases.category_id=category.id  order by cases.id desc limit 5";
    $res=mysqli_query($con,$sql);
    ?>
    <div class="row">
        <div class="col-12">
