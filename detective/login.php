...
if(isset($_POST['submit'])){
    ...
    $sql="select * from user where username='$username' and password='$password' and role='detective' and status=1  ";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['DETECTIVE_IS_LOGIN']='yes';
      $_SESSION['DETECTIVE_USER']=$row['name'];
      $_SESSION['DETECTIVE_ID']=$row['id'];
      redirect('index.php');
    }else{
