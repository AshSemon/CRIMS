...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['archive'])){
    ...
    mysqli_query($con,"update cases set archive_id='$archive' where id='$id'");
    redirect(SITE_PATH.'detective/case_details.php?id='.$id);
  }
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div>
                  <div class="container-fluid w-100">
                    ...
                    <div>
                      <?php
                      echo "<h4>Assign to Archive :- ".getArchiveById($courtRow['archive_id'])."</h4>"
                      ?>
              ...
              <script>
                function updatearchiveAssign(){
                  ...
                  if(archive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>detective/case_details.php?id='+oid+'&archive='+archive;
                  }
                }
