...
if(isset($_GET['id']) && $_GET['id']>0){
  ...
  if(isset($_GET['archive'])){
    ...
    mysqli_query($con,"update returned set achive_id='$archive' where id='$id'");
    redirect(SITE_PATH.'detective/return_details.php?id='.$id);
  }
  $sql="SELECT * FROM returned where id='$id' ORDER BY id desc";
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div>
                  <div class="container-fluid w-100">
                    ...
                    <?php
                      $archiveAssignRes=mysqli_query($con,"select * from user where role='archive' and status=1 order by id asc");
                    ?>
                    <div>
                      <?php
                      echo "<h4>Assign to Archive :- ".getArchiveById($courtRow['achive_id'])."</h4>"
                      ?>
              ...
              <script>
                function updatearchiveAssign(){
                  ...
                  if(archive!=''){
                    var oid="<?php echo $id?>";
                    window.location.href='<?php echo SITE_PATH?>detective/return_details.php?id='+oid+'&archive='+archive;
                  }
                }
