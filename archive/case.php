...
$sql="select cases.*,category from cases,category where cases.archive_id='".$_SESSION['ARCHIVE_ID']."' and casetype='0' and cases.category_id=category.id  order by cases.id desc limit 6";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['sended']=='0'){ ?>
                            <a href="case_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to WSJD</label></a>
                        <?php }else{ ?>
