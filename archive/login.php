...
if(isset($_POST['submit'])){
    ...
    $sql="select * from user where username='$username' and password='$password' and role='archive' and status=1 ";
    $res=mysqli_query($con,$sql);
    if(mysqli_num_rows($res)>0){
      $row=mysqli_fetch_assoc($res);
      $_SESSION['ARCHIVE_IS_LOGIN']='yes';
      $_SESSION['ARCHIVE_USER']=$row['name'];
      $_SESSION['ARCHIVE_USER_NAME']=$row['username'];
      $_SESSION['ARCHIVE_ID']=$row['id'];
      redirect('index.php');
    }else{
        ...
        <div class="main-panel  col-lg-12">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo date('Y')?> <a href="#" target="_blank">SemiProj</a>. All rights reserved.</span>
                </div>
            </footer>
      </div>
    </div>
