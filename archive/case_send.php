...
$msg="";
// Create connection
$conn = mysqli_connect("localhost:3306","root","","jcrms");
// Check connection
if(isset($_POST['submit'])){
  ...
  $added_on=date('Y-m-d h:i:s');
      ...
      mysqli_query($conn,"insert into cases(caseid,priority,casetype,accuser,agender,adob,aaddress,aphone,awork,pstatement,defendent,dgender,ddob,dmother,dfather,dwork,dfamily,daddress,dphone,dstatement,cine,accusation,imprisioned,arn,investigated,assigned,witness,statement,invest_statement,status,added_on) values('$caseid','$priority','$casetype','$accuser','$agender','$adob','$aaddress','$aphone','$awork','$pstatement','$defendent','$dgender','$ddob','$dmother','$dfather','$dwork','$dfamily','$daddress','$dphone','$dstatement','$cine','$accusation','$imprisioned','$arn','$detective','$archive','$witness','$statement','$invest_statement',1,'$added_on')");
...
if(!isset($_SESSION['ARCHIVE_IS_LOGIN'])){
    redirect('login.php');
}
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    <div class="accordion">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Case ID" name="caseid" required value="<?php echo $courtRow['id']?>" readonly>
                      </div>
                      <div class="form-group">
                          <label for="exampleInputName1">Case priority</label>
                          <input type="text" class="form-control" placeholder="Case ID" name="priority" required value="<?php echo $courtRow['casetype']?>" readonly>
                      </div>
							        <!--- 1 ---> 
                      <div class="contentBx">
                        ...
                        <div class="content">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Case Type" name="casetype" required value="<?php echo $courtRow['category']?>" readonly>
                          </div>
                      ...
                      <div class="contentBx">
                        ...
                        <br>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Investigater Name" name="detective" required readonly value="<?php echo getDetectiveNameById($courtRow['detective_id'])?>">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputName1">Assigned by :  </label>
                            <input type="text" class="form-control" placeholder="Archive Name" name="archive" required readonly value="<?php echo getArchiveById($courtRow['archive_id'])?>">
                          </div>
                          ...
                          <div class="form-group" id="dish_box1">
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <input type="text" class="form-control" placeholder="Witness Name" name="witness" required value="<?php echo $cases_details_row['witness']?>" readonly>
                                </div>
                                <div class="col-5">
                                    <input type="text" class="form-control" placeholder="Witness Statement" name="statement" required value="<?php echo $cases_details_row['statement']?>" readonly>
                                </div>
                            </div>
                            <?php } ?>                
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" placeholder="INVERSTIGATION statement" name="invest_statement" id="" cols="30" rows="10" readonly><?php echo $cases_invest_row['invest_statement']?></textarea>
                            </div>
                            <?php } ?>
                        </div>
                      </div>
