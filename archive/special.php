...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
    ...
    if($type=='send'){
        $sended=1;
		mysqli_query($con,"update cases set sended='$sended' where id='$id'");
		redirect('case.php');
	}
...
$sql="select cases.*,category from cases,category where cases.category_id=category.id and cases.user_id='".$_SESSION['SUB_ADMIN_USER_ID']."' and casetype='1' and cases.archive_id='".$_SESSION['ARCHIVE_ID']."' order by cases.id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <?php if($row['sended']=='0'){ ?>
                            <a href="special_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to WSJD</label></a>
                        <?php }else{ ?>
