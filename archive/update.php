...
if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
    ...
    if($type=='send'){
        $sended=1;
		mysqli_query($con,"update returned set sended='$sended' where id='$id'");
		redirect('case.php');
	}
...
$sql="select * from returned where achive_id='".$_SESSION['ARCHIVE_ID']."' order by id desc";
        ...
        <div class = "item-list">
                ...
                <div class = "item">
                    ...
                    <div class = "item-detail">
                        ...
                        <span href = "#" class = "item-name">Assigned by :  <?php echo getDetectiveNameById($row['detective_id'])?></span>
                        ...
                        <?php if($row['sended']=='0'){ ?>
                            <a href="update_send.php?id=<?php echo $row['id']?>"><label class="btn btn-success hand_cursor">Send to WSJD</label></a>
                        <?php }else{ ?>
